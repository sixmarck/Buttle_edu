...
public class EndView {
	...
	public static void boardList(ArrayList<BoardDTO> list) {
		for (BoardDTO a : list) {
			System.out.println(a);
		}
	}

	public static void accidentList(ArrayList<AccidentDTO> list) {
		for (AccidentDTO a : list) {
			System.out.println(a);
		}
	}
	...
	public static void successMsgAll5(int returnMoney) {
